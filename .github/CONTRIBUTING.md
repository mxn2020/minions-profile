# Contributing to Minions Profile

Thank you for your interest in contributing to Minions Profile!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-profile.git`
