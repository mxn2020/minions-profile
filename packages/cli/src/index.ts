...
/**
 * @minions-profile/cli — CLI for Minions profile
 */
...
import { customTypes } from '@minions-profile/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions profile'));
        console.log(chalk.dim('Your source of truth — verified bio claims, portfolio items, and rate cards'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-profile/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-profile/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions_profile')}`);
